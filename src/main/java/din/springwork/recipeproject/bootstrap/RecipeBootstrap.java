package din.springwork.recipeproject.bootstrap;

import din.springwork.recipeproject.model.*;
import din.springwork.recipeproject.repositories.CategoryRepository;
import din.springwork.recipeproject.repositories.RecipeRepository;
import din.springwork.recipeproject.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!eachUomOptional.isPresent()) {
            log.debug("'Each' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if (!tableSpoonUomOptional.isPresent()) {
            log.debug("'Tablespoon' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if (!teaSpoonUomOptional.isPresent()) {
            log.debug("'Teaspoon' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if (!dashUomOptional.isPresent()) {
            log.debug("'Dash' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if (!pintUomOptional.isPresent()) {
            log.debug("'Pint' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if(!cupsUomOptional.isPresent()){
            log.debug("'Cup' UOM is not present in DB", new RuntimeException("Expected UOM not Found"));
        }
        ...
        if(!americanCategoryOptional.isPresent()){
            log.debug("'American' Category is not present in DB", new RuntimeException("Expected Category Not Found"));
        }
        ...
        if(!mexicanCategoryOptional.isPresent()){
            log.debug("'Mexican' Category is not present in DB", new RuntimeException("Expected Category Not Found"));
        }
